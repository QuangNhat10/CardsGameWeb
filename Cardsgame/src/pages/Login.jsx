...
// Logo game thẻ bài (bạn có thể thay bằng logo riêng nếu muốn)
const logo =
...
// Background chủ đề thẻ bài
const duelBg =
  "https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1200&q=80"; // Bạn có thể thay bằng ảnh bàn đấu Yu-Gi-Oh! hoặc ảnh fantasy
  ...
  return (
    <div
      style={{
        ...
        background: `linear-gradient(135deg, #0f172acc 20%, #1e1b4bcc 50%, #312e81cc 100%), url('${duelBg}')`,
