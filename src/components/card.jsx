...
export function Card({ children, className = "", ...props }) {
  return (
    <div className={`bg-card text-card-foreground rounded-lg shadow p-4 ${className}`} {...props}>
      {children}
    </div>
  );
}
...
export function CardFooter({ children, className = "", ...props }) {
  return (
    <div className={`mt-2 flex items-center justify-between ${className}`} {...props}>{children}</div>
  );
}
